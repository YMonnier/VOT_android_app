package pm12016g3.tln.univ.fr.vot.features.consult.create.algorithms.stv;
...
@EFragment(R.layout.consult_create_algo_stv_fragment)
@OptionsMenu(R.menu.consult_create_menu_two_arrows)
public class STVFragment extends AppFragment
        implements View.OnClickListener, Validable {
    private static final String TAG = STVFragment.class.getSimpleName();
    ...
    @ViewById(R.id.s_quota)
    Spinner sQuota;

    @ViewById(R.id.s_elimination)
    Spinner sElimination;

    @ViewById(R.id.et_winner_nb)
    EditText etWinenrNb;
